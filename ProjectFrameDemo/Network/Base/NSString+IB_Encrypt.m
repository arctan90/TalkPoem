...
//
//  NSString+IB_Encrypt.m
//  ProjectFrameDemo
//
//  Created by Rick on 16/1/19.
...
{
    //kCCEncrypt 加密
    return [self encrypt:self encryptOrDecrypt:kCCEncrypt key:DES_KEY];
}

- (NSString *)decrypt
{
    //kCCDecrypt 解密
    return [self encrypt:self encryptOrDecrypt:kCCDecrypt key:DES_KEY];
}
